...
public class BruteForceAlgorithmTest {
     ...
     * Logger Instance
     */
    private static Logger logger = Logger.getLogger(BruteForceAlgorithmTest.class);
    ...
    public void executeTest (){
        IAlgorithm alg = new BruteForceAlgorithm();
        ...
        //check the result values of the BruteForceAlgorithm

        assertEquals("Wrong number of iterations", 6, result.getIterations());
        ...
        assertEquals("Wrong number of iterations",6, result2.getIterations());
